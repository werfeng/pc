package com.wf.pc.common;

public class UrlConstant {

    public static final String BAIDUZHISHU_URL = "https://baidurank.aizhan.com/baidu/%s/%s/0/%s/position/1/";
...
//    public static final String BAIDUZHISHU_PREFIX_URL = "https://baidurank.aizhan.com/baidu/www.zhihu.com/-1/0/1/position/1/";
    ...
    //获取href
    public static final String VK="value";
    public static final String VKH="href";
}
